...
//$('#step').click(function(){
////	$(this).parents().find('.content-box').find('.content').find('div:nth-child(3)').addClass('div-color')
////	$(this).parents().find('.content-box').find('.content').find('i:nth-child(2)').addClass('i-color');
////	$(this).parents().find('.content-btm').addClass('hide')
//	$(location).attr('href','register-student-identity.html')
//})
...
$('.student-box .next-step').click(function(){
	$(location).attr('href','register-student-identity.html')
})
